...
class Parameter9 : public COleDispatchDriver
{
public:
	Parameter9() {}		// Calls COleDispatchDriver default constructor
	Parameter9(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	Parameter9(const Parameter9& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
...
class Parameters9 : public COleDispatchDriver
{
public:
	Parameters9() {}		// Calls COleDispatchDriver default constructor
	Parameters9(LPDISPATCH pDispatch) : COleDispatchDriver(pDispatch) {}
	Parameters9(const Parameters9& dispatchSrc) : COleDispatchDriver(dispatchSrc) {}
